...
sceneCreateUserModule = require("src/scenes/sceneCreateUser")
...
ecransTransitionsModule = require("src/polish/ecransTransitions")
...
require("src/utils")
require("src/polish/tweening")
require("src/polish/camShake")
require("src/polish/shaders")
require("src/polish/systemParticles")
require("src/maths")
